...
const PATTERNS = [
  {
    ...
    description: "Code-split components with React.lazy. Suspense boundaries show fallbacks while chunks load.",
  ...
  },
  {
    ...
    description: "Catch rendering errors and show graceful fallback UI. Every production app needs these.",
  ...
  },
  {
    ...
    description: "createPortal renders children outside the parent DOM node, which is essential for modals and tooltips.",
  ...
  },
  {
    ...
    path: "/patterns/hoc",
    description: "Functions that take a component and return an enhanced version. withLoading, withAuth, withLogger.",
  ...
  },
  {
    ...
    description: "Share logic via a prop that is a function. The component calls your function with its state.",
  ...
  },
  {
    ...
    description: "Components designed to work together, sharing implicit state via Context. Like Ant Design's Select + Option.",
