...
export const metadata: Metadata = {
  ...
  description,
  keywords: [
    "React", "React hooks", "useState", "useEffect", "useReducer", "useMemo",
    "useCallback", "useRef", "useContext", "Context API", "Redux Toolkit",
    "React 19", "useOptimistic", "useTransition", "useDeferredValue",
    "custom hooks", "React patterns", "frontend learning", "JavaScript",
  ],
