...
const HOOKS = [
  {
    ...
    description:
      "Mark state updates as non-urgent transitions. Keeps the UI responsive while expensive renders happen.",
  ...
  },
  {
    ...
    description:
      "Defer updating a non-urgent part of the UI. The input stays fast; the slow list catches up after.",
  ...
  },
  {
    ...
    description:
      "Generate stable unique IDs for accessibility attributes (htmlFor, aria-*) that work in SSR.",
  ...
  },
  {
    ...
    description:
      "Show the expected result of an action immediately while the real async operation runs in the background.",
    ...
    <div>
      <div style={{ marginBottom: 40 }}>
        ...
        <Paragraph style={{ fontSize: 15, maxWidth: 640 }}>
          Introduced in React 18 and 19, these hooks unlock concurrent features: keeping your UI
          fast and responsive even under heavy load.
        </Paragraph>
      </div>
